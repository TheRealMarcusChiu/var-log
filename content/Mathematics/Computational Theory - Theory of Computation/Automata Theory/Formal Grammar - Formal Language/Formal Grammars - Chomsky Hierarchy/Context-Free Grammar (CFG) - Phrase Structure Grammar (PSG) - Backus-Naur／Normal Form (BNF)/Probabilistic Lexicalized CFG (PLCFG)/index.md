...
![[Mathematics/Computational Theory - Theory of Computation/Automata Theory/Formal Grammar - Formal Language/Formal Grammars - Chomsky Hierarchy/Context-Free Grammar (CFG) - Phrase Structure Grammar (PSG) - Backus-Naur／Normal Form (BNF)/Probabilistic Lexicalized CFG (PLCFG)/probabilistic-lexicalized-context-free-grammar.png|400]]
...
![[Mathematics/Computational Theory - Theory of Computation/Automata Theory/Formal Grammar - Formal Language/Formal Grammars - Chomsky Hierarchy/Context-Free Grammar (CFG) - Phrase Structure Grammar (PSG) - Backus-Naur／Normal Form (BNF)/Probabilistic Lexicalized CFG (PLCFG)/plcfg-solution-example.png|400]]
