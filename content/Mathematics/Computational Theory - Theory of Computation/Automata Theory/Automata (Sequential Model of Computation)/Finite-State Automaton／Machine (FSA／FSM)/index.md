...
![[Mathematics/Computational Theory - Theory of Computation/Automata Theory/Automata (Sequential Model of Computation)/Finite-State Automaton／Machine (FSA／FSM)/deterministic-finite-state-automaton.png|330]]

###### Non-Deterministic FSA (multiple choices for input a)

![[Mathematics/Computational Theory - Theory of Computation/Automata Theory/Automata (Sequential Model of Computation)/Finite-State Automaton／Machine (FSA／FSM)/non-deterministic-finite-state-automaton.png|330]]

###### Non-Deterministic FSA (<strong>ϵ-transition)</strong>

![[Mathematics/Computational Theory - Theory of Computation/Automata Theory/Automata (Sequential Model of Computation)/Finite-State Automaton／Machine (FSA／FSM)/non-deterministic-finite-state-automaton-2.png|330]]
