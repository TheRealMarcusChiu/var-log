...
> 5. thus we differentiate <font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦) + 𝑔(𝑦)</font> with respect to 𝑦 and set it equal to <font style="color: rgb(255,102,0);">𝑁(𝑥,𝑦)</font>
>    - 𝑑𝜑/𝑑𝑦 = <font style="color: rgb(255,102,0);">𝑁(𝑥,𝑦)</font>
...
> 6. once the equation (𝛿/𝛿𝑦)(<font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦) + 𝑔(𝑦)</font>) =<font style="color: rgb(255,102,0);"> 𝑁(𝑥,𝑦)</font> is computed we solve for <font style="color: rgb(128,0,0);">𝑔(𝑦)</font>
> 7. next we come back to the equation <font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦) + 𝑔(𝑦)</font><font style="color: rgb(128,0,0);"><font style="color: rgb(51,51,51);"> and plugin what we found at step 3.c<font style="color: rgb(77,81,86);"> for </font>𝑔(𝑦)</font></font>:
> 8. 𝜑(𝑥,𝑦) = <font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦) + 𝑔(𝑦)</font>
> 9. 𝜑(𝑥,𝑦) = <font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦)</font> + (thing from 3.c)
> 10. <font style="color: rgb(128,0,0);"><font style="color: rgb(51,51,51);">next we take the original DE</font></font>
> 11. now we merge (4.b) and (5.f) and get:
> 12. <font style="color: rgb(128,0,0);">𝐹(</font><font style="color: rgb(128,0,0);">𝑥,𝑦)</font> + (thing from 3.c) = 𝐶
> 13. next we apply the initial conditions to solve for 𝐶
> 14. once we solve for 𝐶 we plug the scalar back into:
> 15. 𝐹(<font style="color: rgb(128,0,0);">𝑥,𝑦)</font> + (thing from 3.c) = 𝑠𝑐𝑎𝑙𝑎𝑟-𝐶
...
> 5. thus we differentiate <font style="color: rgb(128,0,0);">𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup> + 𝑔(𝑦)</font> with respect to 𝑦 and set it equal to 2𝑥𝑦
>    - 𝑑𝜑/𝑑𝑦 = <font style="color: rgb(255,102,0);">𝑁(𝑥,𝑦) = 2𝑥𝑦</font>
...
>    - ∫𝑑𝑔(𝑦) = ∫0·𝑑𝑦
>    - 𝑔(𝑦) = 0 + 𝑐 = 𝑐
> 7. next we come back to the equation <font style="color: rgb(128,0,0);">𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup> + 𝑔(𝑦)<font style="color: rgb(51,51,51);"> and plugin <font style="color: rgb(77,81,86);">𝑐 for </font>𝑔(𝑦)</font></font>:
>
...
> 6. <font style="color: rgb(128,0,0);"><font style="color: rgb(51,51,51);">𝜑(𝑥,𝑦) = </font></font>𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup>= 𝐶
> 7. next we apply the initial condition 𝑦(1) = 2 to solve for 𝐶
> 8. 1<sup>2</sup> + 1·2<sup>2</sup>= 𝐶
> 9. 𝐶 = 5
> 10. the solution is then:
> 11. 𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup>= 𝐶
> 12. 𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup>= 5
> 13. 𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup>- 5 = 0
> 14. 𝑥𝑦<sup>2</sup>+ 𝑥<sup>2</sup>- 5 = 0
> 15. solve for 𝑦:
> 16. 𝑦 = \[(5 - 𝑥<sup>2</sup>)/𝑥]<sup>(1/2)</sup>
> 17. or using the quadratic equation:
> 18. 1. 𝑥<sup>2</sup> + 𝑥𝑦<sup>2</sup>= 5
