...
> [!indent]
> ![[Mathematics/Mathematical Analysis/Calculus/Multivariable／Multi-Variable／Multivariate Calculus／Analysis/Jacobian Matrix/jacobian-matrix.png|350]]

# Jacobian Matrix - Examples

> [!expand]- Example 1 <strong>𝒇</strong>: ℝ<sup><em>2</em></sup> → ℝ<sup><em>3</em></sup>
>
> ![[Mathematics/Mathematical Analysis/Calculus/Multivariable／Multi-Variable／Multivariate Calculus／Analysis/Jacobian Matrix/jacobian-matrix-example.png|450]]
>
> since 𝐉 is not a square matrix, there is no Jacobian Determinant

> [!expand]- Example 2 <strong>𝒇</strong>: ℝ<sup><em>2</em></sup> → ℝ<sup><em>2</em></sup>
>
> ![[Mathematics/Mathematical Analysis/Calculus/Multivariable／Multi-Variable／Multivariate Calculus／Analysis/Jacobian Matrix/jacobian-matrix-example-2.png|450]]
>
