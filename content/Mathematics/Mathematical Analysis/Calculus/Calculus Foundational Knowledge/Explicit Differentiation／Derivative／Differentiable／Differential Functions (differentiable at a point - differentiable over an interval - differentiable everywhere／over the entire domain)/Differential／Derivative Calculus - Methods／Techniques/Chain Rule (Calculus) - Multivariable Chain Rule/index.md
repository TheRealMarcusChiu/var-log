...
> [!indent]
> ![[Mathematics/Mathematical Analysis/Calculus/Calculus Foundational Knowledge/Explicit Differentiation／Derivative／Differentiable／Differential Functions (differentiable at a point - differentiable over an interval - differentiable everywhere／over the entire domain)/Differential／Derivative Calculus - Methods／Techniques/Chain Rule (Calculus) - Multivariable Chain Rule/chain-rule.png|301]]
...
>
> ![[Mathematics/Mathematical Analysis/Calculus/Calculus Foundational Knowledge/Explicit Differentiation／Derivative／Differentiable／Differential Functions (differentiable at a point - differentiable over an interval - differentiable everywhere／over the entire domain)/Differential／Derivative Calculus - Methods／Techniques/Chain Rule (Calculus) - Multivariable Chain Rule/multivariable-chain-rule-example.png|600x157]]
