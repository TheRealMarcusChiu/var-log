...
>
> ![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probabilistic Inference/Probabilistic Inference - Algorithms/Probabilistic Inference - Exact Inference/Probabilistic Inference - Bucket Tree Elimination (BTE) - Collect & Distribute Algorithm/sample-bayesian-network.png|301]]
>
...
>
> ![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probabilistic Inference/Probabilistic Inference - Algorithms/Probabilistic Inference - Exact Inference/Probabilistic Inference - Bucket Tree Elimination (BTE) - Collect & Distribute Algorithm/bucket-elimination-example.png|350]]
>
...
> 2. 𝜋<sub>𝐴→𝐵</sub>(𝑎) = 𝐏(𝐴)
> 3. the second is executed by 𝑏𝑢𝑐𝑘𝑒𝑡<sub>𝐵</sub>, computing a function (a product) that is moved to 𝑏𝑢𝑐𝑘𝑒𝑡<sub>𝐷</sub>
> 4. 𝜋<sub>𝐵→𝐷</sub>(𝑎, 𝑏) = 𝐏(𝑏|𝑎) · 𝜋<sub>𝐴→𝐵</sub>(𝑎) · 𝜆<sub>𝐶→𝐵</sub>(𝑎, 𝑏)
> 5. the final computation is carried in 𝑏𝑢𝑐𝑘𝑒𝑡<sub>𝐷</sub>. The belief 𝐏(𝐷 | 𝐄=𝐞) can be computed in 𝑏𝑢𝑐𝑘𝑒𝑡<sub>𝐷</sub>
> 6. 𝐏(𝐷|𝐄=𝐞) =<strong> 𝛴<sub>𝑎∊𝐴</sub>𝛴<sub>𝑏∊𝐵</sub> <strong>\[</strong></strong> 𝐏(𝐷=𝑑|𝐴=𝑎,𝐵=𝑏) · 𝜋<sub>𝐵→𝐷</sub>(𝑎, 𝑏) <strong>] </strong>/ 𝐏(𝐄=𝐞)
>
...
>
> ![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probabilistic Inference/Probabilistic Inference - Algorithms/Probabilistic Inference - Exact Inference/Probabilistic Inference - Bucket Tree Elimination (BTE) - Collect & Distribute Algorithm/bucket-tree-algorithm-propagation-of-messages.png|350]]
>
...
>
> ![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probabilistic Inference/Probabilistic Inference - Algorithms/Probabilistic Inference - Exact Inference/Probabilistic Inference - Bucket Tree Elimination (BTE) - Collect & Distribute Algorithm/bucket-tree-algorithm-augmented-output-bucket-tree.png|400]]
...
> ###### Pseudocode
>
> ![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probabilistic Inference/Probabilistic Inference - Algorithms/Probabilistic Inference - Exact Inference/Probabilistic Inference - Bucket Tree Elimination (BTE) - Collect & Distribute Algorithm/bucket-tree-elimination-algorithm.png|400]]
