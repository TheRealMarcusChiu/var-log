...
You can use the following formula to find the percent for any set of data: <span style="white-space: pre-wrap"><code>Percent of Regression to the Mean = 100(1-r)</code></span>
