...
![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probability Distribution Models／Representations/Probabilistic Graphical Models (PGM) - Structured Probabilistic Models (SPM)/PGM - Model Types/Markov Networks／Nets - Markov Random Fields (MRF)/MN／MRF - Variants (Gibbs Distribution)/Conditional／Discriminative Random Fields (CRF)/log-linear-model.png|400]]
...
![[Mathematics/Probability - Statistics - Information Theory - Econometrics/Probability/Probability Distribution Models／Representations/Probabilistic Graphical Models (PGM) - Structured Probabilistic Models (SPM)/PGM - Model Types/Markov Networks／Nets - Markov Random Fields (MRF)/MN／MRF - Variants (Gibbs Distribution)/Conditional／Discriminative Random Fields (CRF)/conditional-random-field-log-linear-model-example.png|600]]
