...
5. update the flow vector f (i.e. compute the next iteration): <strong>f</strong><sup>(j+1)</sup> = (1 - α<sub>j</sub>)<strong>Φ</strong><sup>(j)</sup>+ α<sub>j</sub><strong>f</strong><sup>(j)</sup>
