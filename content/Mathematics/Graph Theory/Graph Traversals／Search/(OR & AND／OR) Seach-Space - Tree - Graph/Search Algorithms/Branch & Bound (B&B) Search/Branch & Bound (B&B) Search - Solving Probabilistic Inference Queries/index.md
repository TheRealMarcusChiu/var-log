...
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/Search Algorithms/Branch & Bound (B&B) Search/Branch & Bound (B&B) Search - Solving Probabilistic Inference Queries/MPE - B&B Search - bn.png]]
>
...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/Search Algorithms/Branch & Bound (B&B) Search/Branch & Bound (B&B) Search - Solving Probabilistic Inference Queries/B&B naive OR-Tree.png]]
>
> ### B\&B Method
>
...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/Search Algorithms/Branch & Bound (B&B) Search/Branch & Bound (B&B) Search - Solving Probabilistic Inference Queries/MPE - B&B Search.png]]
>
