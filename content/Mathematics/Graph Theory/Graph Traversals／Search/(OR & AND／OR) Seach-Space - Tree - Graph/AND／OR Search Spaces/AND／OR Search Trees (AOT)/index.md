...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/AND／OR Search Spaces/AND／OR Search Trees (AOT)/AND-OR-Search-Tree-primal-graph-pseudo-tree.png|500]]
>
...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/AND／OR Search Spaces/AND／OR Search Trees (AOT)/AND-OR-search-tree-examples.png|600]]
