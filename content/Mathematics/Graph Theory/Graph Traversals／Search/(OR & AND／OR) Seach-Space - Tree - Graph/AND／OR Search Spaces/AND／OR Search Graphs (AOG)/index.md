...
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/AND／OR Search Spaces/AND／OR Search Graphs (AOG)/and-or-search-example-primal-graph.png|301]]
>
...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/AND／OR Search Spaces/AND／OR Search Graphs (AOG)/and-or-search-tree-example.png|301]]
>
...
>
> ![[Mathematics/Graph Theory/Graph Traversals／Search/(OR & AND／OR) Seach-Space - Tree - Graph/AND／OR Search Spaces/AND／OR Search Graphs (AOG)/and-or-search-graph-example.png|400]]
