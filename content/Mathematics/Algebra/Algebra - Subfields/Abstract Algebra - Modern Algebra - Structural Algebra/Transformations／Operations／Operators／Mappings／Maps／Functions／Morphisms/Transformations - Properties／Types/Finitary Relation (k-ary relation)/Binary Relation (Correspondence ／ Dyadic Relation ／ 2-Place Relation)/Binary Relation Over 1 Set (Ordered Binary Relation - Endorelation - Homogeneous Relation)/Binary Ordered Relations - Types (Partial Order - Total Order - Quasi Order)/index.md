...
>
> ![[Mathematics/Algebra/Algebra - Subfields/Abstract Algebra - Modern Algebra - Structural Algebra/Transformations／Operations／Operators／Mappings／Maps／Functions／Morphisms/Transformations - Properties／Types/Finitary Relation (k-ary relation)/Binary Relation (Correspondence ／ Dyadic Relation ／ 2-Place Relation)/Binary Relation Over 1 Set (Ordered Binary Relation - Endorelation - Homogeneous Relation)/Binary Ordered Relations - Types (Partial Order - Total Order - Quasi Order)/partial set.png|330x250]]
>
...
>
> ![[Mathematics/Algebra/Algebra - Subfields/Abstract Algebra - Modern Algebra - Structural Algebra/Transformations／Operations／Operators／Mappings／Maps／Functions／Morphisms/Transformations - Properties／Types/Finitary Relation (k-ary relation)/Binary Relation (Correspondence ／ Dyadic Relation ／ 2-Place Relation)/Binary Relation Over 1 Set (Ordered Binary Relation - Endorelation - Homogeneous Relation)/Binary Ordered Relations - Types (Partial Order - Total Order - Quasi Order)/total order example (1).jpg|582x150]]
>
