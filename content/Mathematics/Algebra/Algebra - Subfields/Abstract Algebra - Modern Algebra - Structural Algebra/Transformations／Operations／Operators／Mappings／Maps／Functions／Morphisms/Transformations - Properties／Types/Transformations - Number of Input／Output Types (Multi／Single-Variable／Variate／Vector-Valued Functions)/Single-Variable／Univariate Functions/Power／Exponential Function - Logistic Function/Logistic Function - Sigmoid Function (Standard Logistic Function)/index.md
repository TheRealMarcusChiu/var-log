...
![[Mathematics/Algebra/Algebra - Subfields/Abstract Algebra - Modern Algebra - Structural Algebra/Transformations／Operations／Operators／Mappings／Maps／Functions／Morphisms/Transformations - Properties／Types/Transformations - Number of Input／Output Types (Multi／Single-Variable／Variate／Vector-Valued Functions)/Single-Variable／Univariate Functions/Power／Exponential Function - Logistic Function/Logistic Function - Sigmoid Function (Standard Logistic Function)/standard-logistic-function-sigmoid-function.png]]
...
![[Mathematics/Algebra/Algebra - Subfields/Abstract Algebra - Modern Algebra - Structural Algebra/Transformations／Operations／Operators／Mappings／Maps／Functions／Morphisms/Transformations - Properties／Types/Transformations - Number of Input／Output Types (Multi／Single-Variable／Variate／Vector-Valued Functions)/Single-Variable／Univariate Functions/Power／Exponential Function - Logistic Function/Logistic Function - Sigmoid Function (Standard Logistic Function)/sigmoid-and-derivative.png|400]]
