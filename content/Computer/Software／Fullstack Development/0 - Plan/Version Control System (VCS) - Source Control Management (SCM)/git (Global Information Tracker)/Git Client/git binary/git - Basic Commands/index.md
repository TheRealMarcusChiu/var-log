...
> [!expand]- Click here to expand...
> git clone <https://github.com/marcuschiukibo/training.git>
>
> - gets a copy of repo into current directory
>
> git clone <https://github.com/marcuschiukibo/training.git> /path
>
...
>
> resolve the conflicts by editing files, then commit <span style="white-space: pre-wrap"><code>  git commit -a (does both ‘git add .’ and ‘git commit’ together)</code></span>
...
> [!expand]- Click here to expand...
> Fetch a remote PR into your local repo <span style="white-space: pre-wrap"><code>git fetch origin pull/\<pull request id>/head:\<lbranch></code><br><code>git checkout \<lbranch></code></span>
