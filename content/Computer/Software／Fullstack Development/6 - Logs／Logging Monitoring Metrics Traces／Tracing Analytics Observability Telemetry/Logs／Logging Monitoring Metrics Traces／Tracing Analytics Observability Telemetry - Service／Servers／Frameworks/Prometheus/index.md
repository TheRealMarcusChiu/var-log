...
###### Prometheus
````excerpt
- is an open-source, [[Logs／Logging Monitoring Metrics Traces／Tracing Analytics Observability Telemetry - Service／Servers／Frameworks|monitoring and alerting framework]]
- it “pulls” [[6 - Logs／Logging Monitoring Metrics Traces／Tracing Analytics Observability Telemetry|metrics]] (measurements) from microservices by sending HTTP requests and stores the results in a time-series database
````
^excerpt
