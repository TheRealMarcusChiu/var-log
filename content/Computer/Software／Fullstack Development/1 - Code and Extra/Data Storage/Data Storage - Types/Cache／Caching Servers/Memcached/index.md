...
> # Install
>
> <strong>1. install using brew in terminal</strong> <span style="white-space: pre-wrap"><code>  brew install memcached</code></span>
>
> <strong>2. test if memcached was installed correctly</strong> <span style="white-space: pre-wrap"><code>  which memcached</code></span>
>
> # Start Stop Restart
>
...
> # Install
>
> <strong>1. install using yum in terminal</strong> <span style="white-space: pre-wrap"><code>  yum install memcached</code></span>
>
> <strong>2. test if memcached was installed correctly</strong> <span style="white-space: pre-wrap"><code>  which memcached</code></span>
>
> # Start Stop Restart
>
> <strong>1. Start</strong> <span style="white-space: pre-wrap"><code>  memcached -p 11111 -U 11111 -u user -d</code></span>
>
...
>
> <strong>2. Stop</strong> <span style="white-space: pre-wrap"><code>  kill \<process-id></code></span>
