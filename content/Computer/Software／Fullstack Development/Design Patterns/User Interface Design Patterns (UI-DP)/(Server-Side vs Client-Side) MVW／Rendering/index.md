...
![[Computer/Software／Fullstack Development/Design Patterns/User Interface Design Patterns (UI-DP)/(Server-Side vs Client-Side) MVW／Rendering/server-side mvc.png|400]]
...
![[Computer/Software／Fullstack Development/Design Patterns/User Interface Design Patterns (UI-DP)/(Server-Side vs Client-Side) MVW／Rendering/client-side mvc.png|400]]
