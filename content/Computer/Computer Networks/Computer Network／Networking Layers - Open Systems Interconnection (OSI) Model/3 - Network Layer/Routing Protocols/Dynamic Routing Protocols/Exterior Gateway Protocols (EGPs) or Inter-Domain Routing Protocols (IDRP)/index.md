...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/3 - Network Layer/Routing Protocols/Dynamic Routing Protocols/Exterior Gateway Protocols (EGPs) or Inter-Domain Routing Protocols (IDRP)/1.png|500]]
