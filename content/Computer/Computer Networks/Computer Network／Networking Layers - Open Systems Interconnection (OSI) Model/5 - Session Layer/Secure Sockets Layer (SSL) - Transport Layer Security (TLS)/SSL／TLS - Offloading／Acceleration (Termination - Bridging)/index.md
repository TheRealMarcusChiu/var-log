...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/5 - Session Layer/Secure Sockets Layer (SSL) - Transport Layer Security (TLS)/SSL／TLS - Offloading／Acceleration (Termination - Bridging)/ssl-offloading-without.png|600]]

### SSL Termination

![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/5 - Session Layer/Secure Sockets Layer (SSL) - Transport Layer Security (TLS)/SSL／TLS - Offloading／Acceleration (Termination - Bridging)/ssl-offloading-termination.png|600]]

### SSL Bridging

![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/5 - Session Layer/Secure Sockets Layer (SSL) - Transport Layer Security (TLS)/SSL／TLS - Offloading／Acceleration (Termination - Bridging)/ssl-offloading-bridging.png|600]]
