...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/4 - Wireless Worldwide Area Network (WWAN)/Cellular Network/Global System for Mobile Communications (GSM) Network/gsm-network.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/4 - Wireless Worldwide Area Network (WWAN)/Cellular Network/Global System for Mobile Communications (GSM) Network/IMSI-obfuscation.png]]
...
<em>![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/4 - Wireless Worldwide Area Network (WWAN)/Cellular Network/Global System for Mobile Communications (GSM) Network/location-updating-request-tmsi-not-established-yet.png|500]]</em>

###### <em>Authentication Request</em>

<em>![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/4 - Wireless Worldwide Area Network (WWAN)/Cellular Network/Global System for Mobile Communications (GSM) Network/authentication-request.png|500]]</em>

###### <em>TMSI / A5/1 Algorithm Supported</em>

<em>![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/4 - Wireless Worldwide Area Network (WWAN)/Cellular Network/Global System for Mobile Communications (GSM) Network/tmsi-a51-algorithm-supported.png|500]]</em>
