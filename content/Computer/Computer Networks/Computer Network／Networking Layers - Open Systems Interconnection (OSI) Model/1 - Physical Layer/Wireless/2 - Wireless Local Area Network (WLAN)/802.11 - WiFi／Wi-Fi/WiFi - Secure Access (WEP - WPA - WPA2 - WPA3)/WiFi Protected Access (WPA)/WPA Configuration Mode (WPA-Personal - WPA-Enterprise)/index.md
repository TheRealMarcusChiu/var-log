...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/2 - Wireless Local Area Network (WLAN)/802.11 - WiFi／Wi-Fi/WiFi - Secure Access (WEP - WPA - WPA2 - WPA3)/WiFi Protected Access (WPA)/WPA Configuration Mode (WPA-Personal - WPA-Enterprise)/WPA-personal-home-network.jpg]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/1 - Physical Layer/Wireless/2 - Wireless Local Area Network (WLAN)/802.11 - WiFi／Wi-Fi/WiFi - Secure Access (WEP - WPA - WPA2 - WPA3)/WiFi Protected Access (WPA)/WPA Configuration Mode (WPA-Personal - WPA-Enterprise)/WPA-enterprise-business-network.jpg]]
