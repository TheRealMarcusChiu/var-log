...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/4 - Transport Layer/Universal／User Datagram Protocol (UDP)/UDP - Header Format/UDP Format.png|596x250]]

![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/4 - Transport Layer/Universal／User Datagram Protocol (UDP)/UDP - Header Format/UDP Queue.png]]
