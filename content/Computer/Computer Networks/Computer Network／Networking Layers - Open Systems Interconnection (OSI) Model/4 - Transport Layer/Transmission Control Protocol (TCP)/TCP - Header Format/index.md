...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/4 - Transport Layer/Transmission Control Protocol (TCP)/TCP - Header Format/TCP Format.png|402x250]]
