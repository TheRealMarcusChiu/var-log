...
<strong>1. execute tunneling command on local machine</strong> <span style="white-space: pre-wrap"><code>  ssh -nNT -R8081:localhost:8080 [marcuschiu-php56.cloudatron.com](http://marcuschiu-php56.cloudatron.com/)</code></span>
