...
>
> ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Reactive Streams/Reactive Socket (RSocket)/fire-and-forget.png]]
...
>
> ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Reactive Streams/Reactive Socket (RSocket)/request-response.png]]
...
>
> ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Reactive Streams/Reactive Socket (RSocket)/request-stream.png]]
...
>
> ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Reactive Streams/Reactive Socket (RSocket)/request-channel.png]]
