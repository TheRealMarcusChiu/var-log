---
publish: true
title: HTTPS - The First Few Milliseconds of an HTTPS Connection
created: 2022-05-08T19:22:03.999-05:00
modified: 2022-05-08T19:31:17.617-05:00
---

original article: <http://www.moserware.com/2009/06/first-few-milliseconds-of-https.html>
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/1.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/2.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/3.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/4.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/5.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/6.png]]

- [server\_name extension](http://tools.ietf.org/html/rfc4366#section-3.1):

  This is a way to tell [Amazon.com](http://amazon.com/) that our browser is trying to reach <https://www.amazon.com/>. This is really convenient because our TLS handshake occurs long before any HTTP traffic. HTTP has a [“Host” header](http://tools.ietf.org/html/rfc2616#section-14.23) which allows a cost-cutting Internet hosting companies to pile hundreds of websites onto a single IP address. SSL has traditionally required a different IP for each site, but this extension allows the server to respond with the appropriate certificate that the browser is looking for. If nothing else, this extension should allow an extra week or so of IPv4 addresses.

> [!list-indent-undo]
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/7.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/8.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/9.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/10.png]]
...
>
> > [!indent]
> > ![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/11.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/12.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/13.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/14.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/15.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/16.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/17.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/18.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/19.png]]
...
Encrypting the plaintext of: <span style="white-space: pre-wrap"><code>GET /gp/cart/view.html/ref=pd\_luc\_mri HTTP/1.1 </code><br><code>Host: [www.amazon.com](http://www.amazon.com/) </code><br><code>User-Agent: Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US; rv:1.9.0.10) Gecko/2009060911 Minefield/3.0.10 (.NET CLR 3.5.30729) </code><br><code>Accept: text/html,application/xhtml+xml,application/xml;q=0.9,\*/\*;q=0.8 </code><br><code>Accept-Language: en-us,en;q=0.5 </code><br><code>Accept-Encoding: gzip,deflate </code><br><code>Accept-Charset: ISO-8859-1,utf-8;q=0.7,\*;q=0.7 </code><br><code>Keep-Alive: 300 </code><br><code>Connection: keep-alive </code><br><code>...</code></span>

will give us the bytes we see on the wire:

![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/20.png]]
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/21.png]]

Decrypting this gives us: <span style="white-space: pre-wrap"><code>HTTP/1.1 200 OK </code><br><code>Date: Wed, 10 Jun 2009 01:09:30 GMT </code><br><code>Server: Server </code><br><code>... </code><br><code>Cneonction: close </code><br><code>Transfer-Encoding: chunked</code></span>
...
![[Computer/Computer Networks/Computer Network／Networking Layers - Open Systems Interconnection (OSI) Model/7 - Application Layer/Hyper Text Transfer Protocol Secure (HTTPS)/HTTPS - The First Few Milliseconds of an HTTPS Connection/22.png]]
