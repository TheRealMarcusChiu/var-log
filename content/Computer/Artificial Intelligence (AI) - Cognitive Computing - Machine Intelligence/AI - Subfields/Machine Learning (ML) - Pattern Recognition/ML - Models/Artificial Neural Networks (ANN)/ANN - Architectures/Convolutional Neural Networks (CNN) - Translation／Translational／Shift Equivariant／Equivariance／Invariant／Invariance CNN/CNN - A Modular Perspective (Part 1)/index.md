...
original article: <http://colah.github.io/posts/2014-07-Conv-Nets-Modular/>
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Artificial Neural Networks (ANN)/ANN - Architectures/Convolutional Neural Networks (CNN) - Translation／Translational／Shift Equivariant／Equivariance／Invariant／Invariance CNN/CNN - A Modular Perspective (Part 1)/cnn-a-modular-perspective-01.png]] <font style="color: rgb(128,128,128);">A 2D Convolutional Neural Network</font>
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Artificial Neural Networks (ANN)/ANN - Architectures/Convolutional Neural Networks (CNN) - Translation／Translational／Shift Equivariant／Equivariance／Invariant／Invariance CNN/CNN - A Modular Perspective (Part 1)/cnn-a-modular-perspective-15.png|400]]Top: 4 correctly classified examples
