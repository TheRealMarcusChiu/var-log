...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Artificial Neural Networks (ANN)/Perceptrons (Artificial Neurons)/Activation Functions (AF) - Comparisons/Sigmoid vs Softmax - Activation Function/sigmoid.png|700x73]]

# Example Softmax Activation Function

![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Artificial Neural Networks (ANN)/Perceptrons (Artificial Neurons)/Activation Functions (AF) - Comparisons/Sigmoid vs Softmax - Activation Function/softmax.png|700x74]]
