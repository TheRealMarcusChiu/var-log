...
> ```
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Model Building/LR - Comparing 2 Models (Extra Sum of Squares & Partial F-Test Statistic)/house-residual-plot.png|301]]
>
> QQ plot
>
> ```
...
> ```
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Model Building/LR - Comparing 2 Models (Extra Sum of Squares & Partial F-Test Statistic)/house-qq-plot.png|301]]
>
...
> ```
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Model Building/LR - Comparing 2 Models (Extra Sum of Squares & Partial F-Test Statistic)/house-new-qq-plot.png|301]]
