...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/linear-algebra-least-squares-projection-matrix-graph.png|130]]
...
> [!indent]
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/linear-algebra-least-square-projection-matrices.png|301]]
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/linear-algebra-least-squares-projection-matrix-graph-solution.png|200]]
...
> - 𝜃<sub>1</sub>= 3/7
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/linear-algebra-least-squares-projection-matrix-graph-other.png|200]]
...
> - 𝑃<strong>𝒚</strong> = 0
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/projection-matrices-intuition-column-space-left-null-space.png|400]]
>
...
>
> ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Regression Models／Analysis (Regressor／Predictor／Independent／Input／Feature-Function - Response／Dependent／Output／Outcome) Variable/Parametric Regression (PR) Models/Continuous Regression Models/Linear Regression (LR) Models/LR - Methods Estimating Unknown Regression Coefficients/LR - Methods Estimating Unknown Coefficients - Method of Least Squares (Projection Matrix - Normal Equation - Pseudoinverse)/linear-algebra-least-squares-projection-matrix-graph-solution-labelled.png|200]]
>
