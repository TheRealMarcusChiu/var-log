...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Reinforcement Learning (RL)/RL Chapters/RL Chapter 12 (Eligibility Traces)/1.png|500]]

offline 𝜆-return algorithm:

- $𝐰_{t+1} = 𝐰\alpha [G_t^\lambda - \hat{v}(S_t,𝐰_t)] \nabla\hat{v}(S_t,𝐰_t), \text{ for } t = 0, ..., T-1$

![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Machine Learning (ML) - Pattern Recognition/ML - Models/Reinforcement Learning (RL)/RL Chapters/RL Chapter 12 (Eligibility Traces)/2.png|600]]
