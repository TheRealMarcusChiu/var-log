...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Natural Language Processing (NLP) - Computational Linguistics/Sentiment Analysis - Opinion Mining - Emotion AI/Word Polarity - Sentiment Lexicon/image-7.png|600]]

### Logical Negation

is logical negation (e.g. no, not) associated with negative sentiment?

![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Natural Language Processing (NLP) - Computational Linguistics/Sentiment Analysis - Opinion Mining - Emotion AI/Word Polarity - Sentiment Lexicon/image-8.png|400]]
