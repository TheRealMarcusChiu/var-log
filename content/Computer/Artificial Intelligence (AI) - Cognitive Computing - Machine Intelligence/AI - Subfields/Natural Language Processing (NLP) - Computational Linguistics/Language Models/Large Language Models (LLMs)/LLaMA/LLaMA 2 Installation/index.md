...
Request model download access: <https://github.com/facebookresearch/llama#download>
...
Prepare data and run: <https://github.com/ggerganov/llama.cpp#prepare-data--run>
