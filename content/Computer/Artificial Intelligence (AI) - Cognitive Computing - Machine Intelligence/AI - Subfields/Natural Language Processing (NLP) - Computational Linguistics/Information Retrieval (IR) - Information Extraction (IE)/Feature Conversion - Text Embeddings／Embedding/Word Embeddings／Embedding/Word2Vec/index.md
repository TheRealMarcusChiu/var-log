...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Subfields/Natural Language Processing (NLP) - Computational Linguistics/Information Retrieval (IR) - Information Extraction (IE)/Feature Conversion - Text Embeddings／Embedding/Word Embeddings／Embedding/Word2Vec/word2vec-cbow-neural-network-architecture.png]]
