...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/Bayesian network for this domain.png|446x250]]
...
###### ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/Representing the full joint distribution.png|301]]
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/Screen Shot 2019-04-20 at 5.25.55 PM.png|397x250]]
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/condional independence.png|445x250]]
...
- Let us suppose these individual inhibition probabilities are as follows: <em>q<sub>cold</sub>= P(¬fever | cold, ¬flu, ¬malaria) = 0.6
...
- Then, from this information and the noisy-OR assumptions, the entire CPT can be built. The general rule is that
  ...
  >
  > > \[!indent]
  > > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/1.png|310]]
- where the product is taken over the parents that are set to true for that row of the CPT. The following table illustrates this calculation
  ...
  >
  > > \[!indent]
  > > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/2.png|340x150]]
...
- Consider the simple example in Figure 14.5, in which a customer buys some fruit depending on its cost, which depends in turn on the size of the harvest and whether the government’s subsidy scheme is operating
  ...
  >
  > > \[!indent]
  > > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/hybrid Bayesian network.png|450]]
...
>
> > [!indent]
> > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/linear Gaussian distribution.png|500]]
...
>
> > [!indent]
> > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/linear gaussian distribution graphs.png|600]]
...
>
> > [!indent]
> > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/standard normal distribution.png|200]]
...
>
> > [!indent]
> > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/standard normal distribution use.png|301]]
...
- - - - which means that the cost threshold occurs around μ, the width of the threshold region is proportional to σ, and the probability of buying decreases as cost increases
  ...
  >
  > > \[!indent]
  > > ![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/probit and logit.png|463x250]]
...
<em><strong>P</strong>(B | j, m) = α ⟨0.00059224, 0.0014919⟩ <strong>P</strong>(B | j, m) ≈ ⟨0.284, 0.716⟩</em>

The structure of <font style="color: rgb(128,128,128);"><em>P(b | j,m)</em></font> computation is shown in Figure 14.8 below
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/The structure of the expression shown in Equation (14.4).png|382x250]]![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/enumeration algorithm for answering queries on Bayesian networks.png|389x250]]
...
![[Computer/Artificial Intelligence (AI) - Cognitive Computing - Machine Intelligence/AI - Textbooks/AI - A Modern Approach - Summaries/AI Chapter 14 - Probabilistic Reasoning/Figure 14.12.png|492x250]]
