...
export default ((opts?: Partial<FolderContentOptions>) => {
  ...
  const FolderContent: QuartzComponent = (props: QuartzComponentProps) => {
    ...
    // Note: the auto-generated child page listing (`<div class="page-listing">`)
    // is intentionally omitted here so folder pages render only their own note
    // content. allPagesInFolder is still computed above for parity with upstream.
